...
<div class="content" :style='{"width":"100%","padding":"30px","margin":"0","overflow":"hidden","background":"rgba(0,0,0,0.5)"}'>
	...
	<div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
		<div :style='{"boxShadow":"none","margin":"0 10px","borderColor":" rgba(0,0,0,0.4)","borderRadius":"4px","background":" rgba(0,0,0,0.3)","borderWidth":"1px 1px 1px 0","display":"flex","borderStyle":"solid"}' v-if="isAuth('dianyingxinxi','首页总数')">
			...
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","background":"","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"24px"}'>{{dianyingxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#fff","height":"24px"}'>电影信息总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
