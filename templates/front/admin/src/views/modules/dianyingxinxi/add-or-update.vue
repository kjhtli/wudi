<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"30px","margin":"0","background":"rgba(0,0,0,0.5)"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="电影名称" prop="moviename">
					<el-input v-model="ruleForm.moviename" placeholder="电影名称" clearable  :readonly="ro.moviename"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else class="input" label="电影名称" prop="moviename">
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="简述" prop="jianshu">
					<el-input v-model="ruleForm.jianshu" placeholder="简述" clearable  :readonly="ro.jianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else class="input" label="简述" prop="jianshu">
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="类型" prop="leixing">
					<el-input v-model="ruleForm.leixing" placeholder="类型" clearable  :readonly="ro.leixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else class="input" label="类型" prop="leixing">
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="时长" prop="shichang">
					<el-input v-model="ruleForm.shichang" placeholder="时长" clearable  :readonly="ro.shichang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else class="input" label="时长" prop="shichang">
					<el-input v-model="ruleForm.shichang" placeholder="时长" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="介绍" prop="jieshao">
					<editor 
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jieshao" label="介绍" prop="jieshao">
                    <span :style='{"border":"1px solid rgba(0,0,0,0.3)","padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","borderRadius":"4px","color":"#fff","background":"rgba(0,0,0,0.4)","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.jieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jieshao = this.ruleForm.jieshao.replace(reg,'../../../djangoty10908c/upload');
        } else {
