	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"30px","margin":"0","background":"rgba(0,0,0,0.5)"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="分类名称" prop="typename">
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else class="input" label="分类名称" prop="typename">
					<el-input v-model="ruleForm.typename"
						placeholder="分类名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="发布人" prop="name">
					<el-input v-model="ruleForm.name" placeholder="发布人" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else class="input" label="发布人" prop="name">
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="简介" prop="introduction">
					<el-input
				...
				<el-form-item :style='{"width":"49%","margin":"0 0 20px 0"}' v-else-if="ruleForm.introduction" label="简介" prop="introduction">
