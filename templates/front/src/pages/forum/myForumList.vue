...
<div :style='{"width":"100%","padding":"0 10%","margin":"0 auto","position":"relative","background":"none"}'>
	...
	<div class="section-title" :style='{"border":"1px solid #D3D3D3","margin":"10px 0","color":"#FF961B","textAlign":"center","background":"#fff","fontSize":"28px","lineHeight":"54px","fontWeight":"bold"}'>我的发布</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column
