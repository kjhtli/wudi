<template>
<div class="forum-preview" :style='{"width":"100%","padding":"0 10%","margin":"0 auto","position":"relative","background":"none"}'>
    <div :style='{"border":"1px solid #D3D3D3","width":"100%","background":"#fff"}'>
		<div :style='{"padding":"0 10px","color":"#FF961B","textAlign":"center","width":"100%","lineHeight":"60px","fontSize":"30px","fontWeight":"bold","height":"60px"}'>影视论坛</div>
	</div>
    <el-form :style='{"padding":"10px","margin":"10px 0","alignItems":"center","flexWrap":"wrap","background":"#f5f5f5","display":"flex","width":"100%","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
		...
		<div :style='{"display":"flex"}'>
			...
			<el-button class="pubBtn" type="primary" @click="toForumAdd">
				<span class="icon iconfont icon-tijiao10" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}'></span>
				发布帖子
			</el-button>
		</div>
    </el-form>
	<div class="z-box" :style='{"width":"100%","padding":"20px"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"color":"#333","alignItems":"center","display":"flex","width":"70%","fontSize":"14px","justifyContent":"flex-start","height":"100%"}' class="item-style">{{item.title}}</div>
		  <div :style='{"color":"#333","alignItems":"center","display":"flex","width":"30%","fontSize":"14px","justifyContent":"flex-end","height":"50%"}' class="item-style">发布人：{{item.username}}</div>
		  <div :style='{"color":"#333","alignItems":"center","display":"flex","width":"30%","fontSize":"14px","justifyContent":"flex-end","height":"50%"}' class="item-style">{{item.addtime}}</div>
		</div>
	</div>
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .section-btn {
	...
	.forum-preview .z-box .section-content {
				...
				color: #333;
				display: flex;
				border-color: rgba(255, 150, 27, 1);
				flex-wrap: wrap;
				border-radius: 5px;
