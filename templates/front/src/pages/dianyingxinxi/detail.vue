		...
		<div class="attr" :style='{"minHeight":"640px","padding":"0","flexWrap":"wrap","background":"#f5f5f5","display":"flex","width":"30%","position":"relative"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"20px 10px","margin":"0","background":"#fff"}'>
				...
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>简述</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.jianshu}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>评分</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.score}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>类型</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.leixing}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>地区</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.diqu}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"0 0","margin":"0 0 0 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"left","width":"auto","fontSize":"12px","lineHeight":"40px","height":"40px"}'>时长</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"12px","lineHeight":"24px","color":"#666","flex":"1"}'>{{detail.shichang}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#fff","outline":"none","borderRadius":"10px","background":"linear-gradient(136deg, #F67055 0%, #FFC054 100%)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"2"}' v-if="btnAuth('dianyingxinxi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #CCCCCC","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#CCCCCC","outline":"none","borderRadius":"10px","background":"none","width":"49%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"6"}' v-if="btnAuth('dianyingxinxi','删除')" @click="delClick">删除</el-button>
