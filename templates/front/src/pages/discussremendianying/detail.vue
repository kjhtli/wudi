		...
		<div class="attr" :style='{"minHeight":"640px","padding":"0","flexWrap":"wrap","background":"#f5f5f5","display":"flex","width":"30%","position":"relative"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"20px 10px","margin":"0","background":"#fff"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#fff","outline":"none","borderRadius":"10px","background":"linear-gradient(136deg, #F67055 0%, #FFC054 100%)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"2"}' v-if="btnAuth('discussremendianying','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #CCCCCC","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#CCCCCC","outline":"none","borderRadius":"10px","background":"none","width":"49%","lineHeight":"40px","fontSize":"14px","height":"40px","order":"6"}' v-if="btnAuth('discussremendianying','删除')" @click="delClick">删除</el-button>
