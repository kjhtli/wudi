...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider4xa7371a && scrapy crawl "+tableName+"Spider -a databaseName=djangoty10908c"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangoty10908c"
        os.system(cmd)
...
def schemaName_mysqldump(request):
    if request.method in ["POST", "GET"]:
        ...
        cmd = "D:/biye/mysql-5.7.32-winx64/bin/mysqldump -h127.0.0.1 -uroot -P3306 -p123456 djangoty10908c > " + filePath
        os.system(cmd)
