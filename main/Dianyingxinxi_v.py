...
def dianyingxinxi_save(request):
    ...
    后台新增
    '''
    request.funname = __name__+"."+dianyingxinxi_save.__name__
    request.operation = "新增电影信息"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def dianyingxinxi_add(request):
    ...
    前台新增
    '''
    request.funname = __name__+"."+dianyingxinxi_add.__name__
    request.operation = "新增电影信息"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def dianyingxinxi_update(request):
    '''
    '''
    request.funname = __name__+"."+dianyingxinxi_update.__name__
    request.operation = "更新电影信息"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def dianyingxinxi_delete(request):
    ...
    批量删除
    '''
    request.funname = __name__+"."+dianyingxinxi_delete.__name__
    request.operation = "删除电影信息"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def dianyingxinxi_importExcel(request):
    request.funname = __name__+"."+dianyingxinxi_importExcel.__name__
    request.operation = "导入电影信息"
    if request.method in ["POST", "GET"]:
