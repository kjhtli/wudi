...
def systemintro_save(request):
    ...
    后台新增
    '''
    request.funname = __name__+"."+systemintro_save.__name__
    request.operation = "新增系统简介"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def systemintro_add(request):
    ...
    前台新增
    '''
    request.funname = __name__+"."+systemintro_add.__name__
    request.operation = "新增系统简介"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def systemintro_update(request):
    '''
    '''
    request.funname = __name__+"."+systemintro_update.__name__
    request.operation = "更新系统简介"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def systemintro_delete(request):
    ...
    批量删除
    '''
    request.funname = __name__+"."+systemintro_delete.__name__
    request.operation = "删除系统简介"
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
...
def systemintro_importExcel(request):
    request.funname = __name__+"."+systemintro_importExcel.__name__
    request.operation = "导入系统简介"
    if request.method in ["POST", "GET"]:
